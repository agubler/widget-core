...
export class WidgetBase<P extends WidgetProperties = WidgetProperties, C extends WidgetBaseInterface = DefaultWidgetBaseInterface> extends Evented implements WidgetBaseInterface<P, C> {
